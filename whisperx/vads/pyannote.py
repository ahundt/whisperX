...
from whisperx.compat import get_pyannote_auth_kwargs
...
def load_vad_model(device, vad_onset=0.500, vad_offset=0.363, use_auth_token=None, model_fp=None):
    ...
    vad_model = Model.from_pretrained(model_fp, **get_pyannote_auth_kwargs(use_auth_token))
...
class VoiceActivitySegmentation(VoiceActivityDetection):
    def __init__(
        ...
        super().__init__(segmentation=segmentation, fscore=fscore, **get_pyannote_auth_kwargs(use_auth_token), **inference_kwargs)
